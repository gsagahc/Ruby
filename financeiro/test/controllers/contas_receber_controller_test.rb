...
class ContasReceberControllerTest < ActionController::TestCase
  setup do
    @contas_receber = contas_receber(:one)
  end

  test "should get index" do
    get :index
    assert_response :success
    assert_not_nil assigns(:contas_receber)
  end
  ...
  test "should destroy contas_receber" do
    ...
    assert_redirected_to contas_receber_index_path
  end
end
